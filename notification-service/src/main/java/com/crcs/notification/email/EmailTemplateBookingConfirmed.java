...
public class EmailTemplateBookingConfirmed implements EmailTemplateInterface {
    ...
    public void setNotification(Notification notification) {
        ...
        this.subject = "Booking Confirmed - " + resourceName;
